					...
					<table class="table table-bordered">
						<tr>
			                <td class="col-sm-1 text-right">
			                    <label for="name1">PID</label>
			                </td>

			                <td class="col-sm-1 text-right">
			                    <label for="name1">Product</label>
			                </td>
			                <td class="col-sm-1 text-right">
			                    <label for="name1">Description</label>
			                </td>
			                <td class="col-sm-1 text-right">
			                    <label for="name1">Dist. info</label>
			                </td>
			                <td class="col-sm-1 text-right">
			                    <label for="name1">Warranty</label>
			                </td>
			                <td class="col-sm-1 text-right">
			                ...
			                <td class="col-sm-1 text-right">
			                    <label for="name1">Discount</label>
			                </td>
			                <td class="col-sm-1 text-right">
                            ...
                            <?php
                                ...
                                for($i=0;$i<$row_number;$i++)
                                {
                                    ...
                                    $dist_info=$myarr[$i]['dist_info'];
                                    $warranty_status=$myarr[$i]['warranty_status'];
                                    $model_number=$myarr[$i]['model_number'];
                                    $price=$myarr[$i]['price'];
                                    $discount=$myarr[$i]['discount'];
                                    $stock_quantity=$myarr[$i]['stock_quantity'];


                                    echo "<form action=\"updateProd.php\" method=\"post\">
	                                    	<tr>
	                                    		<td class=\"col-sm-1 text-right\">
	                                    			<label name=\"pid\">" .$pid.  "</label>
	                                			</td>
	                                			<input type=\"hidden\" name=\"pid\" value=\"" .$pid."\"/>
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$pname. "\" name=\"pname\">
	                                			</td>

	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$description. "\" name=\"description\">
	                                			</td>
	                                			
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$dist_info. "\" name=\"dist_info\">
	                                			</td>
	                                			
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$warranty_status. "\" name=\"warranty_status\">
	                                			</td>
	                                			
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$model_number. "\" name=\"model_number\">
	                                			</td>
	                                			
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$price. "\" name=\"price\">
	                                			</td>
	                                			
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$discount. "\" name=\"discount\">
	                                			</td>
	                                			
	                                    		<td>
	                                    			<input id=\"name1\" class=\"form-control\" placeholder=\"" .$stock_quantity. "\" name=\"stock_quantity\">
	                                			</td>
